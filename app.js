...
const API_KEY = '';  //i will give the api key
...
mongoose.connect(' ', { useNewUrlParser: true });  // i will give the mongodb server url
...
app.get('/complaint',(req,res)=>{
  res.render('complaint.ejs',{title:'',body:''});
});
...
app.get('/complaintmess',(req,res)=>{
  res.render('complaintmess.ejs',{title:'',body:''});
});
